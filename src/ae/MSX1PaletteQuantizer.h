...
enum MSX1PQ_ParamId {
    ...
    // Read-only swatches (appended to avoid changing legacy param layout)
    MSX1PQ_PARAM_TOPIC_PALETTE_SWATCHES,
    MSX1PQ_PARAM_COLOR_BOX_1,
    MSX1PQ_PARAM_COLOR_BOX_2,
    MSX1PQ_PARAM_COLOR_BOX_3,
    MSX1PQ_PARAM_COLOR_BOX_4,
    MSX1PQ_PARAM_COLOR_BOX_5,
    MSX1PQ_PARAM_COLOR_BOX_6,
    MSX1PQ_PARAM_COLOR_BOX_7,
    MSX1PQ_PARAM_COLOR_BOX_8,
    MSX1PQ_PARAM_COLOR_BOX_9,
    MSX1PQ_PARAM_COLOR_BOX_10,
    MSX1PQ_PARAM_COLOR_BOX_11,
    MSX1PQ_PARAM_COLOR_BOX_12,
    MSX1PQ_PARAM_COLOR_BOX_13,
    MSX1PQ_PARAM_COLOR_BOX_14,
    MSX1PQ_PARAM_COLOR_BOX_15,
    MSX1PQ_PARAM_TOPIC_PALETTE_SWATCHES_END,
