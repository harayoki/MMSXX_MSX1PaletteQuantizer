...
enum MSX1PQ_ParamId {
    ...
    MSX1PQ_PARAM_DISABLE_COLOR1, // Disable basic color #1
    MSX1PQ_PARAM_DISABLE_COLOR2,
    MSX1PQ_PARAM_DISABLE_COLOR3,
    MSX1PQ_PARAM_DISABLE_COLOR4,
    MSX1PQ_PARAM_DISABLE_COLOR5,
    MSX1PQ_PARAM_DISABLE_COLOR6,
    MSX1PQ_PARAM_DISABLE_COLOR7,
    MSX1PQ_PARAM_DISABLE_COLOR8,
    MSX1PQ_PARAM_DISABLE_COLOR9,
    MSX1PQ_PARAM_DISABLE_COLOR10,
    MSX1PQ_PARAM_DISABLE_COLOR11,
    MSX1PQ_PARAM_DISABLE_COLOR12,
    MSX1PQ_PARAM_DISABLE_COLOR13,
    MSX1PQ_PARAM_DISABLE_COLOR14,
    MSX1PQ_PARAM_DISABLE_COLOR15,
